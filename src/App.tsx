...
// ==========================================================
// 2. DỮ LIỆU MẪU LỊCH SỬ (MOCK DATA)
// ==========================================================
...
function App() {
  ...
  useEffect(() => {
    ...
    // Hàm lấy giá Crypto từ Binance API (Đã mã hóa URL cho iOS)
      ...
      try {
        ...
        if (Array.isArray(data)) {
          data.forEach((item: any) => {
            ...
            // Định dạng số: DOGE, XRP, ADA lấy 4 số lẻ; còn lại lấy 2
  ...
  // Cấu hình Icon Coin (Server CMC siêu ổn định)
  const coinBlocks = [
      ...
      <main className="flex-grow overflow-y-auto pb-28 p-4 block">
        {activeTab === 'trade' ? (
          <div className="w-full max-w-md mx-auto flex flex-col gap-5 animate-slide-up">
            ...
            {/* KHỐI 8 ĐỒNG COIN (4 CỘT x 2 HÀNG) */}
